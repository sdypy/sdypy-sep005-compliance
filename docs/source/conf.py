...
latex_documents = [
    (
        master_doc,
        "sdypy_template_project.tex",
        "SDyPy project template project Documentation",
        "Janko Slavič, Domen Gorjup, Klemen Zaletelj",
        "manual",
    ),
]
...
man_pages = [
    (
        ...
        "SDyPy project template Documentation",
        [author],
        1,
    )
]
